 ...
 */
void* server_global_rpc_handler(int8_t id, tangram_uct_addr_t* client, void* data, uint8_t* respond_id, size_t *respond_len) {
    *respond_len = 0;
    void *respond = NULL;
...
void tangram_server_global_start(tfs_info_t* tfs_info) {
    ...
    tangram_ucx_server_register_rpc(server_global_rpc_handler);
